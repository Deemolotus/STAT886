...
\begin{itemize}
    ...
    1 & 3   & 9  & 1           & $1-\frac{1}{9} = \frac{8}{9}$        & $\frac{8}{9}^2 \frac{1}{9(9-1)} = 0.011$                                                                          \\\hline
    2 & 4   & 8   & 1           & $\frac{8}{9}(1-\frac{1}{8}) = \frac{7}{9}$    & $\frac{7}{9}^2 [\frac{1}{9(9-1)} + \frac{1}{8(8-1)}] = 0.019$                                                    \\\hline
    3 & 6   & 7   & 2           & $\frac{7}{9}(1-\frac{2}{7}) = \frac{5}{9}$    & $\frac{5}{9}^2 [\frac{1}{9(9-1)} + \frac{1}{8(8-1)} + \frac{2}{7(7-2)}] = 0.027$                                  \\\hline
    4 & 9   & 5   & 1           & $\frac{5}{9}(1-\frac{1}{5}) = \frac{4}{9}$    & $\frac{4}{9}^2 [\frac{1}{9(9-1)} + \frac{1}{8(8-1)} + \frac{2}{7(7-2)} + \frac{1}{5(5-1)}] = 0.027$               \\\hline
    5 & 13  & 1   & 1           & $\frac{4}{9}(1-1) = 0$                & $0^2 [\frac{1}{9(9-1)} + \frac{1}{8(8-1)} + \frac{2}{7(7-2)} + \frac{1}{5(5-1)} + \frac{1}{1-1}] = 0$ \\\hline
    \end{tabular}
    \end{table}
    ...
    \begin{align*}
        ...
        &= 3 + \frac{8}{9}*1 + \frac{7}{9}*2 + \frac{5}{9}*3 + \frac{4}{9}*4 + 0\\
        &= 8.9
    \end{align*}
