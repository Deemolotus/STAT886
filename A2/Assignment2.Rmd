...
\begin{itemize}
    ...
    1 & 3   & 9  & 1           & $1-\frac{1}{9} = \frac{8}{9}$        & $0.9^2 \frac{1}{10(10-1)} = 0.009$                                                                          \\\hline
    2 & 4   & 8   & 1           & $\frac{8}{9}(1-\frac{1}{8}) = \frac{7}{9}$    & $0.8^2 [\frac{1}{10(10-1)} + \frac{1}{9(9-1)}] = 0.016$                                                    \\\hline
    3 & 6   & 7   & 2           & $\frac{7}{9}(1-\frac{2}{7}) = \frac{5}{9}$    & $0.6^2 [\frac{1}{10(10-1)} + \frac{1}{9(9-1)} + \frac{2}{8(8-2)}] = 0.024$                                  \\\hline
    4 & 9   & 5   & 1           & $\frac{5}{9}(1-\frac{1}{5}) = \frac{4}{9}$    & $0.5^2 [\frac{1}{10(10-1)} + \frac{1}{9(9-1)} + \frac{2}{8(8-2)} + \frac{1}{6(6-1)}] = 0.025$               \\\hline
    5 & 13  & 1   & 1           & $\frac{4}{9}(1-1) = 0$                & $0^2 [\frac{1}{10(10-1)} + \frac{1}{9(9-1)} + \frac{2}{8(8-2)} + \frac{1}{6(6-1)} + \frac{1}{1-1}] = 0$ \\\hline
    \end{tabular}
    \end{table}
